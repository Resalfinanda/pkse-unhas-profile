        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-accent-foreground/80 text-sm leading-relaxed">
              Paguyuban KSE UNHAS adalah wadah bagi penerima beasiswa KSE untuk
              berkembang bersama dan berkontribusi kepada masyarakat.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              ...
              <a
                href="https://www.tiktok.com/@pkse.unhas"
                className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-all duration-200"
              >
